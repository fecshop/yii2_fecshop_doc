...
1.如果您想要重写fecshop原来的功能，可以参看：
[Fecshop 重写功能](fecshop-rewrite-func.md)

2.如果您想做新的功能扩展
，那么需要建立自己的module

在appadmin本地新建模块前，建议先去了解一下fecshop appadmin端的代码：

`@fecshop/app/appadmin/modules` 下面就是fecshop appadmin入口的模块部分。

了解清楚fecshop后台的大致原理，您就可以自己写一个本地模块了，下面是一个例子，
